...
/*   Updated: 2023/01/21 03:04:06 by brda-sil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	error_print_params(t_error err, t_parse parse)
{
	...
	if (have_base_error)
		error_print_base(err.params, parse.map.file.err_no);
	if (have_known_error)
		error_print_params_known(err, parse);
	if (have_map_error)
