...
/*   Updated: 2023/01/08 21:43:47 by brda-sil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_putstr_fd(ERRN_ARGS_STR_10, 2);
...
{
	ft_putstr_fd(ERRN_ARGS_STR_11, 2);
...
{
	ft_putstr_fd(ERRN_ARGS_STR_12, 2);
